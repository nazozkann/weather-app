        ...
        <main className="relative z-10 p-4 text-gray-800 dark:text-gray-200 min-h-screen flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              ></div>
              <div
                className="text-2xl sm:text-3xl lg:text-4xl font-[300] mb-2"
                aria-live="polite"
              >
                {t("loading")}...
              </div>
    ...
    >
      ...
      <main className="relative z-10 p-4 text-gray-800 dark:text-gray-200 min-h-screen font-outfit font-[300]">
        ...
        <div
          ...
          role="main"
          aria-labelledby="city-day-heading"
        >
          <h1
            id="city-day-heading"
            className="text-2xl sm:text-3xl lg:text-4xl mb-6 sm:mb-8 text-center font-[400]"
          >
            {city} - {dayString}
          </h1>
